...
const LogoutIcon = ({ color = '#919191' }: { color?: string }) => {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width='24' height='25' viewBox='0 0 24 25' fill='none'>
			<path d='M7.62415 11.0619V13.9885' stroke={color} stroke-width='1.3' stroke-linecap='round' />
			<path
			...
			<path
				...
				stroke-width='1.3'
			/>
			<path d='M13.569 12.6664L21.1025 12.6664' stroke={color} stroke-width='1.3' stroke-linecap='round' />
			<path
